...
const (
	...
	// 战斗相关消息 (0x0200 - 0x02FF)
	MsgCreateBattle  uint16 = 0x0201 // 创建战斗
	MsgJoinBattle    uint16 = 0x0202 // 加入战斗
	MsgLeaveBattle   uint16 = 0x0203 // 离开战斗
	MsgStartBattle   uint16 = 0x0204 // 开始战斗
	MsgEndBattle     uint16 = 0x0205 // 结束战斗
	MsgBattleAction  uint16 = 0x0206 // 战斗行动
	MsgBattleResult  uint16 = 0x0207 // 战斗结果
	MsgBattleStatus  uint16 = 0x0208 // 战斗状态
	...
	MsgGetPlayerInfo    uint16 = 0x0801 // 获取玩家信息
	MsgGetOnlinePlayers uint16 = 0x0802 // 获取在线玩家
	MsgGetBattleInfo    uint16 = 0x0803 // 获取战斗信息
